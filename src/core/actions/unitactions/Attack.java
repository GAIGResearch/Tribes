        ...
        if(isFeasible(gs)) {
            ...
            if (target.getCurrentHP() <= attackResult) {
                ...
                switch (attacker.getType()) {
                    ...
                    case KNIGHT:
                    case SUPERUNIT:
                    gs.getBoard().tryPush(attackerTribe, attacker, attacker.getPosition().x, attacker.getPosition().y, target.getPosition().x, target.getPosition().y, gs.getRandomGenerator(),gs);
                }
